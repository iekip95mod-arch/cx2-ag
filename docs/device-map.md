...
`optics`, `unit_conversion` (lua_module.cc:4038), `vector_addition` (lua_module.cc:4041),
`vector_cross` (lua_module.cc:4042), `components_to_magnitude_angle`, `magnitude_angle_to_components`,
