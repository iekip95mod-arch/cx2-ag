...
`source`: read on 2026-09-25. nps/lua/nps_v4.lua:2787 sends projectile true for the thrown ball, and
the problem table at nps/lua/nps_v4.lua:2798-2805 carries no projectile key at all, which is how the
...
**`D2Editor` rich text**, the typeset path. mathBox builds it at nps/lua/nps_v4.lua:3218, measureMath
sets the expression at :3252, and the history editor sets its expression at :1438.
