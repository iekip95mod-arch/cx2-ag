...
**`D2Editor` rich text**, the typeset path. mathBox builds it at nps/lua/nps_v4.lua:3199, measureMath
sets the expression at :3233, and the history editor sets its expression at :1437.
