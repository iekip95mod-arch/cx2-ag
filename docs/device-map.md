...
**`D2Editor` rich text**, the typeset path. mathBox builds it at nps/lua/nps_v4.lua:3156 and sets the
expression at :3190, and the history editor sets its expression at :1437.
