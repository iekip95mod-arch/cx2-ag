...
| Codex | .codex/config.toml selects never approval and danger-full-access for this autonomous repository. Start from this trusted repository. Read [CODEX.md](../CODEX.md) for hosted worker credentials, branch ownership, PR review and desktop wake-ups |
