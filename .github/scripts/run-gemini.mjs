...
import { githubHostedGemini } from './prepare-gemini.mjs';
import { agentDeadline } from './agent-deadline.mjs';

export function runGemini({ startedAt, timeoutMinutes, prompt, binary, now, mode = 'reply', model = 'gemini-3.8-flash-high', effort = 'high', directory, schema, sandbox = true }, execute = spawnSync) {
