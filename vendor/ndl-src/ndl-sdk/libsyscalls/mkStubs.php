...
__attribute__((naked)) $rettype $matches[5]($matches[6])
{
	asm volatile("push {r0-r4, lr}\\n"
				...
				"mov r12, r0\\n"
				"pop {r0-r4, lr}\\n"
				"bx r12\\n" :: [nr] "i" ($matches[1] | __SYSCALLS_ISVAR));
}
