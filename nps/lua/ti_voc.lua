...
local terms = {
	...
	{ name = "Free-fall acceleration", ch = 2, sym = "g, 9.80 m/s²",
		eq = { "a = −g,  g = 9.80 m/s²" },
		def = {
			...
			"",
			"Near Earth's surface g = 9.80 m/s².",
		} },
	...
	{ name = "Right-hand rule", ch = 3,
		def = {
			...
			"",
			"To use it, put the two vectors tail to",
			"tail. Curl the fingers of the right hand",
			"so they sweep the first vector into the",
			"second through the smaller angle. The",
			"outstretched thumb points along a × b.",
			"",
			"Sweeping the other way turns the thumb",
			"around, which is why b × a is −(a × b).",
		} },
	{ name = "Scalar", ch = 3,
		def = {
