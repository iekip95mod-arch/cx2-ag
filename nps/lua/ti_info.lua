...
local cards = {
	{
		...
		lines = {
			...
			"change of speed.",
			"",
			"YOU NEED  any three of these five",
			"v\226\130\128  speed at the start      m/s",
			"v   speed at the end        m/s",
			"a   how fast the speed changes, per second",
			"    m/s\194\178. Positive points along +x",
			"t   how long it took         s",
			"\206\148x  how far it ended up from the start, m",
			"    \206\148 means change in. Negative if it ended",
			"    up behind where it began",
			"",
			...
			{ m = "v^2=v\226\130\128^2+2*a*\206\148x", alt = "v\194\178 = v\226\130\128\194\178 + 2 a \206\148x" },
			"",
			"STEPS",
	...
	},
	{
		...
		lines = {
			...
			"",
			"YOU NEED",
			"\206\148y  height change, m. Up positive, so a fall",
			"    is negative",
			"v\226\130\128  speed at the moment it was released",
			"v   speed at the moment you care about",
	...
	},
	{
		...
		lines = {
			...
			"",
			"YOU NEED  the formula for x, and the times",
			"x     position at time t, m. The formula",
			"      gives it for any t you put in",
			"\206\148x    change in position between two times",
			"\206\148t    the gap between those two times, s",
			"v_avg average velocity over a stretch, m/s",
			"v     velocity at one instant, m/s",
			"a     acceleration at one instant, m/s\194\178",
			"",
			"dx/dt means differentiate x with respect to",
			"t. On this calculator, d/dt in the template.",
			"",
			"FORMULA",
	...
	},
	{
		...
		lines = {
			...
			"t   the clock reading, s. It is the same",
			"    number for both objects, and it is the",
			"    only thing they share",
			"\206\148y  drop height for the falling one, m",
	...
	},
	{
		...
		lines = {
			...
			"v\226\130\128  launch speed, m/s. The speed along the",
			"    slanted path at the instant it left",
			"\206\184   launch angle above the horizontal, degrees",
			"v\226\130\128x sideways part of v\226\130\128, m/s",
			"v\226\130\128y upward part of v\226\130\128, m/s",
			"g   9.80 m/s\194\178, the size of gravity, always",
			"    positive. Up positive makes a = \226\136\146g",
			"",
	...
	},
	{
		...
		lines = {
			...
			"v\226\130\128y upward part of the launch speed, m/s.",
			"    Get it from v\226\130\128 sin\206\184 on the angle card",
			"g   9.80 m/s\194\178",
			"H   greatest height above the launch point, m",
			"R   range, how far along the ground it lands",
			"    from where it left, m",
			"t_up time from launch to the highest point, s",
			"",
			"FORMULA",
	...
	},
	{
		...
		lines = {
			...
			"",
			"YOU NEED  both vectors in component form",
			"i j k are direction labels, not numbers.",
			"i means one step along x, j along y, k",
			"along z. So 3i means 3 units in the x",
			"direction.",
			"",
			...
			"and meters in the same sum is the usual",
			"lost mark.",
		},
	},
	{
		...
		lines = {
			...
			"",
			"YOU NEED  either the pair, or the pair",
			"a   the magnitude, meaning the size of the",
			"    vector with no direction attached. Never",
			"    negative. Same unit as the thing itself",
			"\206\184   the angle from the +x axis, degrees,",
			"    counterclockwise unless told otherwise",
			"ax  how much of it points along x",
			"ay  how much of it points along y",
			"",
			"Either pair determines the other. Given a",
			"and \206\184 you get the components, given the",
	...
	},
	{
		...
		lines = {
			...
			"",
			"YOU NEED  both vectors, either form",
			"a . b the scalar product. A plain number,",
			"      not a vector. The dot is part of the",
			"      name and does not mean multiply",
			"\207\134     the angle between the two vectors when",
			"      they are drawn tail to tail, degrees",
			"a, b   their magnitudes, the sizes with no",
	...
	},
	{
		...
		lines = {
			...
			"",
			"YOU NEED  both vectors in components",
			"a \195\151 b the vector product. The answer is a",
			"      VECTOR, unlike the dot product",
			"\207\134     the angle between them, for the size",
			"Perpendicular means at right angles to.",
			"The result points at right angles to both",
			"of the originals at once.",
			"",
			...
			"   | bx   by   bz |",
			"",
			"i  (ay bz \226\136\146 az by)",
			"j  \226\136\146(ax bz \226\136\146 az bx)",
			"k  (ax by \226\136\146 ay bx)",
			"",
			"STEPS",
	...
	},
	{
		...
		lines = {
			...
			"",
			"YOU NEED  two of the three velocities",
			"The two letters after v say who is moving",
			"and who is watching, in that order.",
			"",
			"v_PB  velocity of P as seen from B",
			"      P is the thing moving, B is the",
			"      observer. A plane's speed through the",
			"      air is v of plane as seen from air",
			"v_BA  velocity of B as seen from A, which",
			"      is usually the wind or the current",
			"v_PA  what you usually want, the velocity",
			"      over the ground",
			"",
			"Relative to means as measured by someone",
			"riding along with that thing.",
			"",
	...
	},
	{
		...
		lines = {
			...
			"",
			"YOU NEED  the formula, not the numbers",
			"To rank is to put in order, largest first",
			"unless the question says otherwise.",
			"",
			"Displacement is where you ended up relative",
			"to where you started, in a straight line.",
			"Distance is how far you actually traveled.",
			"Four paths between the same two points have",
			"the same displacement and different",
			"distances, and most ranking questions turn",
			"on exactly that.",
			"",
			"STEPS",
	...
	},
	{
		...
		lines = {
			...
			"",
			"YOU NEED",
			"\207\129   density, kg/m\194\179. The Greek letter rho,",
			"    not a p. How much mass sits in each",
			"    unit of volume",
			"m   mass, kg",
			"V   volume, m\194\179",
			"",
			"Significant figures are the digits that",
			"carry real information. Your answer gets as",
			"many as the least precise number you were",
		...
		topics = {
			...
			},
			{
				...
				lines = {
					...
					"negative displacement and a is \226\136\146g.",
		...
		topics = {
			...
			},
			{
				...
				lines = {
					...
					"",
					"1  V = 2.0 × 3.0 × 4.0 = 24 cm³",
					"2  ρ = m / V = 48 g / 24 cm³",
					"3  ρ = 2.0 g/cm³",
					"",
					"4  convert, one ratio at a time",
					"   2.0 g/cm³ × (1 kg / 1000 g)",
					"                × (10⁶ cm³ / 1 m³)",
					"",
					"   ρ = 2000 kg/m³",
					"",
