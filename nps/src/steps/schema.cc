...
const EvidenceAlternative kRationalReading[] = {
    {"exact rational function reading", EvidenceStrength::StructurallyValid},
};
...
const EvidenceAlternative kDenominatorEvaluation[] = {
    {"exact denominator evaluation", EvidenceStrength::StructurallyValid},
};
...
const EvidenceAlternative kPolynomialDivision[] = {
    {"exact polynomial division", EvidenceStrength::StructurallyValid},
};
