...
accepted_input_forms linsolve menu command in Exact mode, for example linsolve([x + y = 3, x - y = 1], [x, y])
...
unsupported_near_neighbors nonlinear systems, symbolic or decimal coefficients, more than four equations or five unknowns, a repeated unknown and items that are not equations. Solving by substitution is a separate method
