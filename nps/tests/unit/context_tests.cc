...
const InstalledModule kExpectedModules[] = {
    ...
    {"solver", "physics.modern.photon-wavelength"},
    {"solver", "physics.modern.photoelectric"},
    {"solver", "physics.modern.mass-energy"},
    {"solver", "physics.relativity.time-dilation"},
    {"solver", "physics.relativity.length-contraction"},
    {"solver", "physics.relativity.lorentz-transformation"},
    {"solver", "physics.relativity.velocity-addition"},
    {"solver", "physics.relativity.energy-momentum"},
