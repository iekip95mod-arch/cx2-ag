...
Gemini jobs use Ubuntu 24.04 x64 for the pinned CLI. Model timeouts include setup time and reserve five minutes for publication. Preserve partial work in the same draft before that deadline. Calculator execution is emulator only.
